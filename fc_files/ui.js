        ...
        $.fn.JSNESUI = function(roms) {
            ...
            var UI = function(nes) {
                ...
                if (typeof roms != 'undefined') {
                    self.setRoms(roms);
                    console.log('init romSelect')
                    self.romSelect.change(function() {
                        console.log('romSelect changed!')
                        self.loadROM();
                    });
                } else {
                    console.log('roms is undefined');
                }
            ...
            UI.prototype = {
                loadROM: function() {
                    ...
                    console.log(self.romSelect.val() + '***')
                    if (self.romSelect.val() != '选择游戏...') {
                ...
                setRoms: function(roms) {
                    ...
                    // console.log(this.romSelect[0])
                    // console.log(this.loadROM)
                    // this.romSelect[0].addEventListener('change',()=>{
                    //     console.log('romSelect changed!')

                    //     this.loadROM();
                    // })
                    // $(this.romSelect[0]).change(() => {
                    //     console.log('romSelect changed!')
                    //     console.log(this.loadROM)
                    //     this.loadROM();
                    // });
